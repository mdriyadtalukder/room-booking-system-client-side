        ...
        <div className='flex h-screen justify-center items-center bg-gradient-to-r from-indigo-200 via-purple-200 to-pink-200'>
            ...
            <div class="bg-white shadow-lg rounded px-20 pt-16 pb-20 mb-12">
                <form onSubmit={login}>
                    ...
                    {errors}
                    <button id='idd' class="w-full btn bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-400 hover:from-pink-400 hover:via-purple-500 hover:to-indigo-500 mt-3.5 mb-3.5">Log In</button>
                </form>
                <div className="text-center pt-2">
                    <button onClick={forgetPassword} className='btn-white text-indigo-500 font-bold'>Forget password?</button>
                </div>
                <div id='idd' className='btn bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-400 hover:from-pink-400 hover:via-purple-500 hover:to-indigo-500 mt-3.5 w-full'>
